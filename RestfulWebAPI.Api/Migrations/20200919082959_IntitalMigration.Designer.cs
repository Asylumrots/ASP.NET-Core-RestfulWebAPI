...
namespace RestfulWebAPI.Api.Migrations
{
    ...
    [Migration("20200919082959_IntitalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestfulWebAPI.Api.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RestfulWebAPI.Api.Entities.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RestfulWebAPI.Api.Entities.Employee", b =>
                {
                    b.HasOne("RestfulWebAPI.Api.Entities.Company", "Company")
                        .WithMany("Employees")
